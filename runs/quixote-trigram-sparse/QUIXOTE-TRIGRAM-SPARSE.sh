...
clang++ -stdlib=libc++ -std=c++11 TrigramSparseMain.cc EMViterbiPackage/Notation.cc CypherReader.cc TagGrammarFinderSparse.cc
./a.out LanguageModels/corpus.spanish.trigrams.txt $cipher_file
carmel --train-cascade -HJ -X .9999 $cipher_file cipher.wfsa cipher.fst 
